...
ggsave('../results/genus/analyse_survivalship/Genus_abundance_survival.png',
...
ggsave('../results/genus/analyse_survivalship/Genus_locality_survival.png',
       width = 12, height = 6, units = 'cm', dpi = 600, plot = p)
...
ggsave('../results/genus/analyse_survivalship/Genus_numloc_survival.png',
       width = 12, height = 6, units = 'cm', dpi = 600, plot = p)
...
ggsave('../results/genus/analyse_survivalship/Genus_numcell_survival.png',
       width = 12, height = 6, units = 'cm', dpi = 600, plot = p)
...
ggsave('../results/genus/analyse_survivalship/Genus_abundance_comparison.png',
       width = 12, height = 6, units = 'cm', dpi = 600, plot = p)
